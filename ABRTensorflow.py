...
l_operand = tf.Variable(initial_value=[i for i in range(2, 10)], dtype='uint8')
r_operand = tf.Variable(initial_value=[[i] for i in range(2, 10)], dtype='uint8')
result = tf.Variable(initial_value=[[0 for i in range(2, 10)] for j in range(2,10)], dtype='uint8')

operation = l_operand * r_operand
